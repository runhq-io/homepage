...
const ABOUT_T = {
  ...
  ko: {
    eyebrow: '소개 · RunHQ',
    h1: 'AI 코딩 agent를 위한 운영 레이어를 만드는 작은 팀.',
    lede: 'agent로 소프트웨어를 출시하는 일은 우리가 평소 쓰던 다른 어떤 도구와도 달랐기에 RunHQ를 시작했습니다. 피드백은 받은편지함에, 티켓은 보드에, 리뷰는 채팅에 흩어져 있던 흐름을 하나의 루프로 합쳤습니다.',
    factFounded: '설립',
    factFoundedV: '2025년',
    factHQ: '본사',
    factHQV: '캐나다 밴쿠버',
    ...
    v2H: 'agent를 운영하세요',
    v2P: '코딩 agent에게 필요한 것은 채팅창이 아니라 일터입니다. 사람과 agent가 나란히 진짜 일을 하는 운영 레이어를 만들고 있습니다.',
    v3H: '평범한 도구, 빠른 팀',
