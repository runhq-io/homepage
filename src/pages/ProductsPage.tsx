...
const PRODUCTS_T = {
  ...
  ko: {
    ...
    heroLede:
      'RunHQ는 누군가 "이거 안 돼요"라고 말하는 순간을 포착해, 재현 가능한 워크스페이스에서 알맞은 agent에게 넘기고, 그 결과 diff를 다시 리뷰어에게 라우팅합니다. 제품 네 개. 큐 하나. 감사 로그 하나.',
    startFree: '무료로 시작하기 →',
    seePricing: '가격 보기',
    ...
    p1Blurb: '오케스트레이션 레이어.',
    p1H1: '정책 가드레일이 적용된 멀티 agent 디스패치',
    ...
    p2Name: '프로젝트 관리',
    p2Pitch:
      '어떤 agent가 어떤 컨텍스트로 실행해 어떤 diff를 만들었는지 아는 티켓. 전체 루프, 하나의 큐, 화면 전환 없음.',
    p2Blurb: '일이 머무는 곳.',
    ...
    p3Name: '개발 환경',
    p3Pitch:
      '격리되고 결정적인 개발 샌드박스를 수 초 만에 띄웁니다. 예열된 환경, 범위가 제한된 자격 증명, 모든 실행 로그 기록. agent에게 필요했던 클린룸입니다.',
    p3Blurb: 'agent가 일하는 곳.',
    p3H1: 'Nix 기반 결정적 환경',
    ...
    step2Source: '프로젝트 관리',
    step2Desc:
      '티켓이 출처, 코드오너 라우팅, 정책이 적용된 채로 큐에 도착해 agent를 기다립니다.',
    step3Label: '실행',
    step3Source: 'agent 자동화 · 개발 환경',
    step3Desc:
