...
const DOC_CARDS_KO: DocCard[] = [
  ...
  { t: '에이전트 실행',              d: '할 일에서 Run을 누르세요. Claude나 Codex가 즉시 이어받아 작업합니다.',                   tag: '시작하기',   icon: '⚡', to: '/docs/run-agent' },
  { t: '변경 사항 리뷰',             d: '에이전트가 작업을 마치면, 무엇을 배포할지는 사람이 결정합니다.',                          tag: '일상 작업',  icon: '◇', to: '/docs/agents/reviewing' },
...
const WELCOME_HERO_KO = (
  <>
    <div className="rhpd-actions">
      ...
      <LL className="rhp-btn-ghost" to="/docs/agents/overview">에이전트가 작동하는 방식</LL>
    </div>
...

  {
    ...
    sections: [
      ...
      },
      {
        ...
        heading: '멘션과 알림',
        body: (
          <P><Kbd>@</Kbd>로 누군가를 멘션하면 알림이 전송됩니다(앱 내, 그리고 사용자가 켜둔 경우 이메일로도). 에이전트를 멘션하면 — <Kbd>@</Kbd>agent-name — 트리아저를 건너뛰고 즉시 그 에이전트에게 할 일이 배정됩니다.</P>
        ),
      },
    ],
  },
