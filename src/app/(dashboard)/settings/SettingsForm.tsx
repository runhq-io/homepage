    ...
    <form onSubmit={handleSubmit} className="space-y-6">
      <div className="bg-slate-800 rounded-lg p-6 space-y-6">
        ...
        <div>
          ...
          <p className="mt-1 text-xs text-slate-400">
            Your Anthropic API key for Claude inference
          </p>
        </div>
        ...
        <div>
          ...
          >
            ...
            <option value="claude-3-5-sonnet-20241022">Claude 3.5 Sonnet (claude-3-5-sonnet-20241022)</option>
            <option value="claude-3-5-haiku-20241022">Claude 3.5 Haiku (claude-3-5-haiku-20241022)</option>
          </select>
          <p className="mt-1 text-xs text-slate-400">
            The Claude model to use for agent inference
          </p>
        </div>
        ...
        <div>
          ...
          />
          <p className="mt-1 text-xs text-slate-400">
            Maximum number of actions an agent can take in a single task
          </p>
        </div>
      </div>
      ...
      <div className="bg-slate-800 rounded-lg p-6 space-y-6">
        ...
        <div>
          ...
          />
          <p className="mt-1 text-xs text-slate-400">
            The base system prompt prepended to all agent interactions
          </p>
        </div>
      </div>
